...
class abms(QMainWindow):
    def __init__(self):
        ...
        self.acconeer_distance = np.zeros(300)
        self.cnt = 0
    ...
    def distance(self):
        ...
        self.distance_canvas = np.zeros((1000, 400, 3), np.uint8)
        ...
        self.frequency_canvas = np.zeros((1000, 400, 3), np.uint8)
